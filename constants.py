...
DEMO_RESUMES = [
    ...
    {"name":"Aryan Desai","experience_years":4,"education":"B.Tech EEE","location":"Mumbai","text":"4 years experience in substation automation. Expertise in RTU configuration, SCADA integration, and grid modernization. Strong background in electrical engineering and power systems."},
    {"name":"Pooja Singh","experience_years":6,"education":"M.Tech Power Systems","location":"Delhi","text":"6 years working on renewable energy projects. Hands-on with BESS, energy storage, and solar PV. Proficient in machine learning for predictive maintenance and artificial intelligence for grid stability."},
    {"name":"Ravi Teja","experience_years":8,"education":"B.E. Electrical","location":"Hyderabad","text":"8 years in EPC and project management for HVDC transmission lines. Deep knowledge of power electronics, procurement, and sustainability. Managed large scale substation projects."},
    {"name":"Neha Sharma","experience_years":3,"education":"B.Tech CS","location":"Bangalore","text":"Data Scientist specializing in the power sector. 3 years applying AI and machine learning to smart grid data. Experienced in Python, IoT, and digital twin technology for asset management."},
    {"name":"Karan Patel","experience_years":5,"education":"M.Tech Energy","location":"Ahmedabad","text":"5 years in renewable energy and green hydrogen. Expertise in energy storage, BESS, and microgrids. Strong focus on sustainability and decarbonization."},
    {"name":"Snehal Kadam","experience_years":7,"education":"B.Tech EEE","location":"Pune","text":"Lead electrical engineering consultant. 7 years in power systems design, short circuit analysis, and ETAP. Extensive work with RTU, PLC, and HMI for substation control."},
    {"name":"Varun Joshi","experience_years":2,"education":"B.Tech Power","location":"Jaipur","text":"2 years experience in grid operations. Focused on demand response, smart meter analytics, and integrating renewable energy into the main grid."},
    {"name":"Anjali Gupta","experience_years":9,"education":"MBA Finance","location":"Mumbai","text":"9 years in power sector commercial operations. Expertise in PPA, financial modelling, and procurement for EPC projects. Strong understanding of ESG and sustainability reporting."},
    {"name":"Sameer Khan","experience_years":4,"education":"M.Tech Power Electronics","location":"Chennai","text":"4 years designing converter systems. Deep knowledge of power electronics, battery storage, and BESS. Familiar with HVDC and grid interconnection standards."},
    {"name":"Roshni Iyer","experience_years":6,"education":"B.Tech EEE","location":"Bangalore","text":"6 years in IT/OT integration for power utilities. Expertise in cybersecurity, OT security, and SCADA. Integrating artificial intelligence for anomaly detection in grid networks."},
    {"name":"Nitin Verma","experience_years":5,"education":"B.Tech EEE","location":"Noida","text":"5 years experience in SCADA and DCS systems. Strong skills in RTU programming, power systems protection, and substation automation. Good electrical engineering foundation."},
    {"name":"Divya Reddy","experience_years":3,"education":"M.Tech Data Science","location":"Hyderabad","text":"3 years applying data analytics to the energy sector. Proficient in machine learning, Python, and predictive maintenance for wind turbines. Exploring AI for grid optimization."},
    {"name":"Prateek Jain","experience_years":8,"education":"B.Tech EEE","location":"Delhi","text":"8 years as an EPC project manager. Managed construction of 400kV substation and HVDC terminals. Handled procurement, HSE, and contractor management."},
    {"name":"Aditi Sen","experience_years":4,"education":"M.Tech Renewables","location":"Kolkata","text":"4 years in renewable energy planning. Expertise in solar PV, wind energy, and BESS sizing. Passionate about sustainability, climate change, and decarbonization strategies."},
    {"name":"Tarun Kumar","experience_years":7,"education":"B.Tech Electrical","location":"Chennai","text":"7 years in power systems analysis. Expert in load flow, ETAP, and grid stability. Recent experience with virtual power plant and energy storage integration."},
    {"name":"Swati Mishra","experience_years":5,"education":"B.Tech CS","location":"Pune","text":"5 years as a software engineer for smart grid solutions. Expertise in cloud (AWS), big data, and IoT. Building AI models for energy forecasting and smart meter analytics."},
    {"name":"Manoj Nair","experience_years":6,"education":"B.Tech EEE","location":"Trivandrum","text":"6 years in power electronics design for EV charging. Knowledge of inverter topologies, BESS, and grid interaction. Strong electrical engineering skills."},
    {"name":"Shruti Das","experience_years":2,"education":"M.Tech Power","location":"Bhubaneswar","text":"2 years experience in grid modernization. Working with synchrophasor data, PMU, and wide area monitoring. Interested in applying machine learning to power systems."},
    {"name":"Gaurav Singh","experience_years":9,"education":"B.Tech EEE","location":"Lucknow","text":"9 years in O&M of thermal and renewable plants. Expertise in RTU, PLC, and switchgear maintenance. Strong focus on safety (LOTO) and energy audit."},
    {"name":"Kiran Patel","experience_years":4,"education":"MBA Operations","location":"Ahmedabad","text":"4 years in supply chain and procurement for solar EPC. Managing vendor relations, feasibility study, and project management for large scale renewable energy projects."}
]
